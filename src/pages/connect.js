...
const ConnectPage = () => (
  ...
  <input className="" placeholder="description" type="checkbox" id="description" name="description"/><br></br>
  </label>
  <p className="agreement">I agree to the privacy policy.</p>
  <label for="description">
  <input className="" placeholder="description" type="checkbox" id="description" name="description"/><br></br>
  </label> 
  <p className="agreement">I agree to the privacy policy.</p>
  <label for="submit">
    <input className="inputSpace" type="submit" value="Submit"/>
  </label>
</form> 
  </Layout>
)
